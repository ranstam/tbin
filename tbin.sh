...
then
    echo
    echo " Usage: tbin.sh parameter [optional]"
    echo
    echo "  -d id                            delete task"
    echo "  -m id item value                 modify task" 
    echo "  -c id                            mark task as completed"
    echo "  -r id time                       remind task (at command)"
    echo "  -e id filename                   download enclosed file"
    echo "  -n [task due show prj con file]  register new task"
    echo "                                      task = job to be performed"
    echo "                                      due  = due date"
    echo "                                      show = show task date"
    echo "                                      prj  = project"
    echo "                                      con  = context"
    echo "                                      file = context"
    echo "  -m                               list projects and contexts"
    echo "  -q                               list queued tasks"
    echo "  -p                               list preregistered tasks"
    echo "  -a [prj/con spec]                list archived (completed) tasks"
    echo "  -l [prj/con spec]                list due tasks"
...
############
    ...
    echo
    echo " For help, run tbin.sh -h or tbin.sh --help"
    echo
fi
